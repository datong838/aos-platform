...
- source/current 同为 `1280×720`；最新当前证据为 `v20-customer-1280x720.png`，comparison 已替换旧 V14 图片引用。
- 当前 panel 为 `x=308 / y=88 / w=972 / h=632`，保持 `280px / minmax / 320px`；body/root 均为 `scrollWidth=clientWidth=1280`，没有横向溢出。
