export const AIP_OPERATIONS = {
  ...
  rejectMemoryCandidate: { method: "POST", path: "/v1/aip/memory-authority/candidates/{candidate_id}/reject", mutation: true },
  ...
  revokeMemoryItem: { method: "POST", path: "/v1/aip/memory-authority/memories/{memory_item_id}/revoke", mutation: true },
