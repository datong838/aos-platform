...
const CONTRIBUTIONS: Record<OperationsSliceId, string> = {
  orders: "以 Order exact authority 支撑跨域运营分诊",
  orderLines: "以 OrderLine exact authority 支撑订单明细核对",
  inventory: "以 ProductSku 库存语义支撑风险识别，不执行库存调整",
  shipments: "以 Shipment exact authority 支撑履约异常识别",
  payments: "以 Payment exact authority 支撑支付状态核对",
  aftersaleEvents: "以 AfterSalesEvent exact authority 支撑售后事件分类",
  operationCases: "以 OperationCase 事件化聚合支撑可逆分诊与 SLA 观察",
};
