...
import { EcommerceWorkshopClientError, type ResponsibilityAssignmentObservation, type TaskCockpitActionReceiptResponse, type TaskCockpitApprovalReviewResponse, type TaskCockpitCoreResponse, type TaskCockpitProductionContextResponse, type TaskCockpitResponsibilityHandoffResponse, type TaskCockpitSkillContributionResponse } from "../../api/ecommerceWorkshop";
...
describe("TaskCockpitPage", () => {
  ...
  it("显式展开 Run 后诚实显示 Step/Checkpoint 空权威集合", async () => {
    const client = { getTaskCockpitCore: vi.fn().mockResolvedValue(core()), listTaskCockpitRunSteps: vi.fn().mockResolvedValue(detailBase), listTaskCockpitRunCheckpoints: vi.fn().mockResolvedValue(detailBase), getTaskCockpitRunProductionContext: vi.fn().mockResolvedValue(productionContext), getTaskCockpitRunResponsibilityHandoffs: vi.fn().mockResolvedValue(responsibilityHandoffs), compileTaskCockpitRunHandoff: vi.fn(), getTaskCockpitRunApprovalReview: vi.fn().mockResolvedValue(approvalReview), getTaskCockpitRunActionReceipts: vi.fn().mockResolvedValue(actionReceipts), getTaskCockpitRunSkillContributions: vi.fn().mockResolvedValue(skillContributions), getResponsibilityAssignmentObservation: vi.fn().mockResolvedValue(assignmentObservation) };
    await act(async () => root.render(<TaskCockpitPage client={client} />));
