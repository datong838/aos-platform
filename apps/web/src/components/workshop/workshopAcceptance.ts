export const WORKSHOP_ACCEPTANCE_MODULES = [
  ...
  { moduleId: "ecommerce.creator-growth", route: "/workshop/creator-growth", label: "达人邀约驾驶舱", tabModel: false },
  { moduleId: "ecommerce.media-studio", route: "/workshop/media-studio", label: "多媒体内容生产", tabModel: true },
