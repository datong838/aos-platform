...
export const INTERACTION_HONESTY_MANIFEST = [
  ...
  {"route":"/aip/model-router","component":"ModelRouterPage","sourceFile":"apps/web/src/pages/s2/aip.tsx","sourceMode":"live","writes":"server","fallbackPolicy":"edit and test use one versioned canonical configuration","tests":["apps/web/src/pages/s2/W3CModelRouterInteractions.test.tsx"]},
  ...
  {"route":"/ontology/graph-health","component":"GraphHealthPage","sourceFile":"apps/web/src/pages/s2/ontology.tsx","sourceMode":"live","writes":"server","fallbackPolicy":"TTL archive requires a server dry run and explicit confirmation","tests":["apps/web/src/pages/s2/W3CGraphHealthInteractions.test.tsx"]},
