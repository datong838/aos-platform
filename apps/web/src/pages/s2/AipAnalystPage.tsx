...
export function AipAnalystPage({ runQuery = queryAnalyst }: { runQuery?: typeof queryAnalyst } = {}) {
  ...
  return <PageChrome title="AIP 分析师" lede="受治理语义 / 知识 / 指标查询；单一结果 revision，不生成演示数据">
    <div data-testid="analyst-ops-stats" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(110px,1fr))", gap: 10, marginBottom: 12 }}>
      {[
        ...
        { label: "证据栏", value: focus || !rightOpen ? "收起" : "展开" },
      ].map((s) => (
