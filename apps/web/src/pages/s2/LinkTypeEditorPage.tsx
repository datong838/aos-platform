...
const linkStyles: Record<string, React.CSSProperties> = {
  ...
  typeBox: { padding: "6px 12px", border: "1px solid var(--aos-accent-border)", borderRadius: "6px", background: "var(--aos-accent-light)", fontSize: "0.7rem", fontWeight: 600, color: "var(--aos-accent-hover)" },
  ...
  swapBtn: { padding: "4px 10px", fontSize: "0.7rem", border: "1px solid var(--aos-border-strong)", borderRadius: "6px", background: "var(--aos-surface)", color: "var(--aos-text-secondary)", cursor: "pointer", flexShrink: 0 },
  typeSelectorRow: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem", marginTop: "0.75rem" },
  warnBox: { marginTop: "0.75rem", padding: "0.5rem 0.75rem", border: "1px solid var(--aos-amber-border)", borderRadius: "6px", background: "var(--aos-amber-bg)" },
  ...
  usageBox: { flex: 1, textAlign: "center" as const, padding: "1rem", border: "1px solid var(--aos-border)", borderRadius: "8px", background: "var(--aos-surface-hover)" },
