...
const linkStyles: Record<string, React.CSSProperties> = {
  ...
  sideNav: { width: 200, flexShrink: 0, borderRight: "1px solid var(--aos-border, #E5E7EB)", padding: "0.5rem" },
  ...
  infoRow: { display: "flex", padding: "0.4rem 0.75rem", borderBottom: "1px solid var(--aos-border, #E5E7EB)", gap: "0.5rem", alignItems: "center" },
  infoKey: { width: 120, fontSize: "0.7rem", fontWeight: 600, color: "var(--aos-text-muted, #6B7280)", flexShrink: 0 },
  infoValue: { flex: 1, fontSize: "0.75rem", color: "var(--aos-text, #374151)", display: "flex", alignItems: "center", gap: "4px", flexWrap: "wrap" },
  monoText: { fontFamily: "ui-monospace, monospace", fontSize: "0.72rem", color: "var(--aos-accent-dark, #3730A3)" },
  symmetricBadge: { padding: "1px 4px", borderRadius: "3px", background: "var(--aos-warning-bg, #FEF3C7)", color: "#92400E", fontSize: "0.6rem" },
  ...
  propLabel: { display: "block", fontSize: "0.7rem", fontWeight: 500, color: "var(--aos-text-muted, #6B7280)", marginBottom: "2px" },
  joinDesc: { fontSize: "0.65rem", color: "var(--aos-text-muted, #9CA3AF)", marginTop: "4px" },
  joinVizDiagram: { display: "flex", alignItems: "center", gap: "0.5rem", flex: "1 1 300px" },
  typeBox: { padding: "6px 12px", border: "1px solid var(--aos-accent-border, #BFDBFE)", borderRadius: "6px", background: "var(--aos-accent-bg, #EFF6FF)", fontSize: "0.7rem", fontWeight: 600, color: "var(--aos-accent-dark, #1E40AF)" },
  arrowRow: { display: "flex", alignItems: "center", gap: "2px" },
  arrowIcon: { fontSize: "0.65rem", fontWeight: 600, color: "var(--aos-text-muted, #6B7280)" },
  arrowLine: { width: 20, height: 2, background: "var(--aos-border, #D1D5DB)" },
  swapBtn: { padding: "4px 10px", fontSize: "0.7rem", border: "1px solid var(--aos-border, #D1D5DB)", borderRadius: "6px", background: "var(--aos-surface, #fff)", color: "var(--aos-text, #374151)", cursor: "pointer", flexShrink: 0 },
  typeSelectorRow: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem", marginTop: "0.75rem" },
  warnBox: { marginTop: "0.75rem", padding: "0.5rem 0.75rem", border: "1px solid #FCD34D", borderRadius: "6px", background: "#FEF3C7" },
  dsRow: { display: "flex", alignItems: "center", gap: "0.5rem", padding: "4px 0", fontSize: "0.75rem" },
  dsLabel: { fontWeight: 500, color: "var(--aos-text-muted, #6B7280)", width: 120 },
  usageRow: { display: "flex", gap: "0.75rem", marginTop: "0.5rem" },
  usageBox: { flex: 1, textAlign: "center" as const, padding: "1rem", border: "1px solid var(--aos-border, #E5E7EB)", borderRadius: "8px", background: "var(--aos-surface-hover, #F9FAFB)" },
  usageNum: { fontSize: "1.5rem", fontWeight: 700, color: "var(--aos-accent, #4F46E5)" },
  usageLabel: { fontSize: "0.7rem", color: "var(--aos-text-muted, #6B7280)", marginTop: "4px" },
};
