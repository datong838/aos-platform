            ...
            {runtimeResolved && (
              <div style={styles.resolvedBox}>
                ...
                {runtimeResolved.unresolved.length > 0 && (
                  <p style={{ fontSize: "0.75rem", color: "var(--aos-text-muted, #6B7280)" }}>
...
const styles: Record<string, React.CSSProperties> = {
  topbar: {
    ...
    padding: "0.5rem 0",
    borderBottom: "1px solid var(--aos-border, #E5E7EB)",
    marginBottom: "0.5rem",
  },
  ...
  versionBadge: {
    padding: "2px 8px",
    borderRadius: "4px",
    background: "var(--aos-accent-bg, #EEF2FF)",
    color: "var(--aos-accent, #4F46E5)",
    fontSize: "0.7rem",
    fontWeight: 600,
  },
  modeSwitcher: { display: "flex", gap: "2px", borderRadius: "6px", overflow: "hidden", border: "1px solid var(--aos-border, #E5E7EB)" },
  modeBtn: {
    padding: "4px 12px",
    fontSize: "0.75rem",
    border: "none",
    background: "var(--aos-surface, #fff)",
    color: "var(--aos-text-muted, #6B7280)",
    cursor: "pointer",
  },
  modeBtnActive: {
    padding: "4px 12px",
  ...
  treePanel: {
    width: 200,
    borderRight: "1px solid var(--aos-border, #E5E7EB)",
    padding: "0.5rem",
    overflowY: "auto",
    background: "var(--aos-surface, #fff)",
  },
  treeSearch: {
    ...
    marginBottom: "0.5rem",
    background: "var(--aos-surface, #fff)",
    color: "var(--aos-text, #111827)",
  },
  treeSectionTitle: { fontSize: "0.65rem", fontWeight: 600, color: "var(--aos-text-muted, #9CA3AF)", textTransform: "uppercase", letterSpacing: "0.5px", margin: "0.5rem 0 0.25rem" },
  treeItem: { display: "flex", alignItems: "center", gap: "4px", padding: "3px 6px", borderRadius: "3px", cursor: "pointer", fontSize: "0.72rem" },
  treeItemActive: { display: "flex", alignItems: "center", gap: "4px", padding: "3px 6px", borderRadius: "3px", cursor: "pointer", fontSize: "0.72rem", background: "var(--aos-accent-bg, #EEF2FF)" },
  kindDot: { width: 8, height: 8, borderRadius: "50%", background: "var(--aos-accent, #3B82F6)", flexShrink: 0 },
  treeItemName: { flex: 1, color: "var(--aos-text, #111827)" },
  treeItemId: { fontSize: "0.6rem", color: "var(--aos-text-muted, #9CA3AF)" },
  addWidgetRow: { display: "flex", flexWrap: "wrap", gap: "2px", marginTop: "0.5rem" },
  addWidgetBtn: { padding: "2px 6px", fontSize: "0.65rem", border: "1px solid var(--aos-border, #E5E7EB)", borderRadius: "3px", background: "var(--aos-surface, #fff)", color: "var(--aos-text-muted, #6B7280)", cursor: "pointer" },
  deleteBtn: { marginTop: "0.5rem", padding: "4px 8px", fontSize: "0.7rem", border: "1px solid var(--aos-danger-border, #FCA5A5)", borderRadius: "4px", background: "var(--aos-danger-bg, #FEE2E2)", color: "var(--aos-danger, #DC2626)", cursor: "pointer", width: "100%" },
  canvas: { flex: 1, overflowY: "auto", padding: "0.75rem" },
  emptyCanvas: { display: "flex", alignItems: "center", justifyContent: "center", height: "100%" },
  widgetCard: { border: "1px solid var(--aos-border, #E5E7EB)", borderRadius: "8px", overflow: "hidden", background: "var(--aos-surface, #fff)" },
  widgetHeader: { display: "flex", alignItems: "center", gap: "0.5rem", padding: "0.5rem 0.75rem", borderBottom: "1px solid var(--aos-border, #E5E7EB)", background: "var(--aos-surface-hover, #F9FAFB)" },
  kindBadge: { padding: "2px 6px", borderRadius: "3px", background: "var(--aos-accent-bg, #EEF2FF)", color: "var(--aos-accent, #4F46E5)", fontSize: "0.65rem", fontWeight: 600 },
  widgetName: { fontWeight: 600, fontSize: "0.8rem", color: "var(--aos-text, #111827)" },
  widgetBody: { padding: "0.75rem" },
  textArea: { width: "100%", minHeight: 150, padding: "0.5rem", border: "1px solid var(--aos-border, #E5E7EB)", borderRadius: "4px", fontFamily: "ui-monospace, monospace", fontSize: "0.75rem", background: "var(--aos-surface, #fff)", color: "var(--aos-text, #111827)" },
  ...
  propsPanel: { width: 260, borderLeft: "1px solid var(--aos-border, #E5E7EB)", overflowY: "auto", background: "var(--aos-surface, #fff)" },
  propsHeader: { padding: "0.5rem 0.75rem", borderBottom: "1px solid var(--aos-border, #E5E7EB)", fontWeight: 600, fontSize: "0.8rem", color: "var(--aos-text, #111827)" },
  propLabel: { display: "block", fontSize: "0.65rem", fontWeight: 500, color: "var(--aos-text-muted, #6B7280)", marginBottom: "2px", marginTop: "0.5rem" },
  propInput: { width: "100%", fontSize: "0.75rem" },
  contentToggle: { display: "flex", gap: "2px", marginBottom: "4px" },
  contentToggleActive: { padding: "2px 8px", fontSize: "0.65rem", border: "1px solid var(--aos-accent, #4F46E5)", borderRadius: "3px", background: "var(--aos-accent, #4F46E5)", color: "#fff" },
  contentToggleBtn: { padding: "2px 8px", fontSize: "0.65rem", border: "1px solid var(--aos-border, #E5E7EB)", borderRadius: "3px", background: "var(--aos-surface, #fff)", color: "var(--aos-text-muted, #6B7280)" },
  codeBlock: { width: "100%", minHeight: 80, padding: "4px 6px", border: "1px solid var(--aos-border, #E5E7EB)", borderRadius: "4px", fontFamily: "ui-monospace, monospace", fontSize: "0.65rem", background: "var(--aos-surface-hover, #F9FAFB)", color: "var(--aos-text, #374151)" },
  summaryBox: { margin: "0.75rem", padding: "0.5rem", border: "1px solid var(--aos-border, #E5E7EB)", borderRadius: "4px" },
  summaryTitle: { fontSize: "0.65rem", fontWeight: 600, color: "var(--aos-text-muted, #9CA3AF)", textTransform: "uppercase", marginBottom: "4px" },
  summaryRow: { display: "flex", justifyContent: "space-between", fontSize: "0.7rem", padding: "1px 0", color: "var(--aos-text, #374151)" },
  workflowPanel: { padding: "0.5rem" },
  workflowBody: { display: "flex", height: "60vh", minHeight: 360, gap: "0.5rem", marginTop: "0.5rem" },
  wfLeftPanel: { width: 200, borderRight: "1px solid var(--aos-border, #E5E7EB)", padding: "0.5rem", overflowY: "auto", background: "var(--aos-surface, #fff)" },
  wfSectionTitle: { fontSize: "0.65rem", fontWeight: 600, color: "var(--aos-text-muted, #374151)", textTransform: "uppercase", letterSpacing: "0.5px", margin: "0.5rem 0 0.25rem" },
  wfNodeTemplate: { display: "flex", alignItems: "center", gap: "4px", padding: "4px 8px", borderRadius: "4px", marginBottom: "3px", cursor: "grab", fontSize: "0.7rem", border: "1px solid", background: "var(--aos-surface, #fff)" },
  wfNodeDot: { width: 8, height: 8, borderRadius: "50%", flexShrink: 0 },
  wfCanvas: { flex: 1, background: "var(--aos-surface-hover, #F9FAFB)", backgroundImage: "radial-gradient(var(--aos-border, #E5E7EB) 1px, transparent 1px)", backgroundSize: "20px 20px", padding: "1rem" },
  wfRightPanel: { width: 260, borderLeft: "1px solid var(--aos-border, #E5E7EB)", padding: "0.5rem", background: "var(--aos-surface, #fff)" },
  runtimePanel: { padding: "0.5rem" },
  resolvedBox: { padding: "1rem", border: "1px solid var(--aos-border, #E5E7EB)", borderRadius: "8px", background: "var(--aos-surface, #fff)", marginBottom: "0.75rem" },
  resolvedContent: { fontFamily: "ui-monospace, monospace", fontSize: "0.75rem", lineHeight: 1.6, color: "var(--aos-text, #111827)" },
  varTable: { padding: "0.75rem", border: "1px solid var(--aos-accent-border, #BFDBFE)", borderRadius: "8px", background: "var(--aos-accent-bg, #EFF6FF)" },
  varTableTitle: { fontSize: "0.75rem", fontWeight: 600, color: "var(--aos-accent-dark, #1E40AF)", marginBottom: "0.5rem" },
  varRow: { display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.7rem", padding: "2px 0" },
  varKey: { color: "var(--aos-accent-dark, #7C3AED)", fontWeight: 600 },
  varArrow: { color: "var(--aos-text-muted, #6B7280)" },
  ...
  versionRow: { display: "flex", alignItems: "center", gap: "0.5rem", padding: "0.4rem 0.75rem", borderBottom: "1px solid var(--aos-border, #E5E7EB)" },
  ...
  currentTag: { fontSize: "0.6rem", color: "var(--aos-accent, #4F46E5)", fontWeight: 600 },
};
