#!/usr/bin/env python3
"""Compose the one approved A02 runnable binding chain without calling Provider.
...
ACTOR = "aip-r2-a02-binding-bootstrap"
...
EVAL_SUITE_ID = "ecommerce.skill.A02.contract.v1"
...
def apply(*, now: datetime | None = None) -> dict[str, Any]:
    ...
    return {
        "status": "A02_BINDING_COMPOSITION_GREEN",
        "scope": {"orgId": SCOPE.org_id, "projectId": SCOPE.project_id},
        "capabilityBinding": {
