#!/usr/bin/env python3
"""Compose the one approved G04 runnable binding chain without calling Provider.
...
ACTOR = "aip-r2-g04-binding-bootstrap"
...
EVAL_SUITE_ID = "ecommerce.skill.G04.contract.v1"
...
def apply(*, now: datetime | None = None) -> dict[str, Any]:
    ...
    return {
        "status": "G04_BINDING_COMPOSITION_GREEN",
        "scope": {"orgId": SCOPE.org_id, "projectId": SCOPE.project_id},
        "capabilityBinding": {
