#!/usr/bin/env python3
"""Compose the one approved I01 runnable binding chain without calling Provider.
...
ACTOR = "aip-r2-i01-binding-bootstrap"
...
EVAL_SUITE_ID = "ecommerce.skill.I01.contract.v1"
...
def apply(*, now: datetime | None = None) -> dict[str, Any]:
    ...
    return {
        "status": "I01_BINDING_COMPOSITION_GREEN",
        "scope": {"orgId": SCOPE.org_id, "projectId": SCOPE.project_id},
        "capabilityBinding": {
