#!/usr/bin/env python3
"""Compose the one approved S04 runnable binding chain without calling Provider.
...
ACTOR = "aip-r2-s04-binding-bootstrap"
...
EVAL_SUITE_ID = "ecommerce.skill.S04.contract.v1"
...
def apply(*, now: datetime | None = None) -> dict[str, Any]:
    ...
    return {
        "status": "S04_BINDING_COMPOSITION_GREEN",
        "scope": {"orgId": SCOPE.org_id, "projectId": SCOPE.project_id},
        "capabilityBinding": {
