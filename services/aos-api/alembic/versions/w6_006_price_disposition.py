"""Typed price case and disposition authority without external effects (W6-06).
...
revision: str = "w6_006"
down_revision: str | Sequence[str] | None = "w6_005"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

TABLES = (
    ("ecommerce_price_case_revision", "case_id"),
    ("ecommerce_price_disposition_contract_revision", "contract_id"),
    ("ecommerce_price_disposition_revision", "disposition_id"),
    ("ecommerce_price_disposition_observation", "observation_id"),
)
