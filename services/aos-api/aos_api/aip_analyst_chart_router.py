"""221plan · Analyst NL2Chart — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_analyst_chart import get_engine, AnalystChartItem

router = APIRouter(prefix="/api/aip/analyst-chart", tags=["aip-analyst_chart"])
_engine = get_engine()
