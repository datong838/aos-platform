"""221plan · Analyst 数据探索 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_analyst_explore import get_engine, AnalystExploreItem

router = APIRouter(prefix="/api/aip/analyst-explore", tags=["aip-analyst_explore"])
_engine = get_engine()
