"""221plan · Assist 全局上下文 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_assist_context import get_engine, AssistContextItem

router = APIRouter(prefix="/api/aip/assist-context", tags=["aip-assist_context"])
_engine = get_engine()
