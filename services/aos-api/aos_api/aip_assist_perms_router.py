"""221plan · Assist 权限感知 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_assist_perms import get_engine, AssistPermsItem

router = APIRouter(prefix="/api/aip/assist-perms", tags=["aip-assist_perms"])
_engine = get_engine()
