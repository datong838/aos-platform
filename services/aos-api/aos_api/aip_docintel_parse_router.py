"""221plan · DocIntel 文档解析 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_docintel_parse import get_engine, DocintelParseItem

router = APIRouter(prefix="/api/aip/docintel-parse", tags=["aip-docintel_parse"])
_engine = get_engine()
