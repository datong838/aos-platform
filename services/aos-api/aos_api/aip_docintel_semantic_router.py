"""221plan · DocIntel 语义理解 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_docintel_semantic import get_engine, DocintelSemanticItem

router = APIRouter(prefix="/api/aip/docintel-semantic", tags=["aip-docintel_semantic"])
_engine = get_engine()
