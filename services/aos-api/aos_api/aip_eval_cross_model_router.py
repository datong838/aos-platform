"""221plan · 跨模型对比 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_eval_cross_model import get_engine, EvalCrossModelItem

router = APIRouter(prefix="/api/aip/eval-cross-model", tags=["aip-eval_cross_model"])
_engine = get_engine()
