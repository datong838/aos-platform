"""221plan · 评测仪表盘 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_eval_dashboard import get_engine, EvalDashboardItem

router = APIRouter(prefix="/api/aip/eval-dashboard", tags=["aip-eval_dashboard"])
_engine = get_engine()
