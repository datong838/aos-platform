"""221plan · LangGraph 运行时 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_langgraph_runtime import get_engine, LangGraphRuntimeItem

router = APIRouter(prefix="/api/aip/langgraph-runtime", tags=["aip-langgraph_runtime"])
_engine = get_engine()
