"""221plan · Logic 版本管理 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_logic_version import get_engine, LogicVersionItem

router = APIRouter(prefix="/api/aip/logic-version", tags=["aip-logic_version"])
_engine = get_engine()
