"""221plan · 模型容量管理 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_model_capacity import get_engine, ModelCapacityItem

router = APIRouter(prefix="/api/aip/model-capacity", tags=["aip-model_capacity"])
_engine = get_engine()
