"""221plan · 模型生命周期 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_model_lifecycle import get_engine, ModelLifecycleItem

router = APIRouter(prefix="/api/aip/model-lifecycle", tags=["aip-model_lifecycle"])
_engine = get_engine()
