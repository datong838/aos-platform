"""221plan · 可观测性仪表盘 — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_obs_dashboard import get_engine, ObsDashboardItem

router = APIRouter(prefix="/api/aip/obs-dashboard", tags=["aip-obs_dashboard"])
_engine = get_engine()
