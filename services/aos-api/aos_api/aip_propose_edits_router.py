"""221plan · ProposeEdits Block — FastAPI 路由。"""
from __future__ import annotations

from fastapi import APIRouter, HTTPException
from pydantic import BaseModel

from .aip_propose_edits import get_engine, ProposeEditsItem

router = APIRouter(prefix="/api/aip/propose-edits", tags=["aip-propose_edits"])
_engine = get_engine()
