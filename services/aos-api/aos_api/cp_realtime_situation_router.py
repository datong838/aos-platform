"""
W6 — 实时态势
Router: /api/cp-realtime-situations
"""
...
router = APIRouter(prefix="/api/cp-realtime-situations", tags=["w6-cp"])
_engine = CpRealtimeSituationEngine()
