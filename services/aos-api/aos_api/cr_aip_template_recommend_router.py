"""
W5 — AIP 代码模板推荐
Router: /api/aip-template-recommends
"""
...
router = APIRouter(prefix="/api/aip-template-recommends", tags=["w5-cr"])
_engine = AipTemplateRecommendEngine()
