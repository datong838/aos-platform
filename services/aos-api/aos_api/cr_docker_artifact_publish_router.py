"""
W6 — Docker 制品发布
Router: /api/docker-artifact-publishes
"""
...
router = APIRouter(prefix="/api/docker-artifact-publishes", tags=["w6-cr"])
_engine = DockerArtifactPublishEngine()
