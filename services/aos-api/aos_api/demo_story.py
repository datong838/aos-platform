...
def demo_story_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "deferred": {
            "apolloOps": False,
            "apolloOpsNote": "160 Apollo 运维深水 MVP 已交付（Change/健康晋升/hotfix）；真多集群舰队仍后置",
            "analyticsNotebook": False,
            "analyticsNotebookNote": "157 真 Jupyter Notebook 7 MVP 已交付；Hub/Lab/R 仍后置",
            "analyticsFullBiMl": True,
            "note": "Apollo 真多集群舰队与 R/任意 SQL/BI·ML 全集仍后置；Full Spoke mock 见 158 · 运维深水见 160",
        },
        "snapshot": snap,
        "steps": steps,
    }
