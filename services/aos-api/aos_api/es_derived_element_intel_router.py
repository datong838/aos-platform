"""
W6 — 派生元素智能
Router: /api/derived-element-intels
"""
...
router = APIRouter(prefix="/api/derived-element-intels", tags=["w6-es"])
_engine = DerivedElementIntelEngine()
