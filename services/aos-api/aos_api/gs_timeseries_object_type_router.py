"""
W6 — 时间序列 Object 类型
Router: /api/timeseries-object-types
"""
...
router = APIRouter(prefix="/api/timeseries-object-types", tags=["w6-gs"])
_engine = TimeseriesObjectTypeEngine()
