"""
W6 — 地理空间数据框架
Router: /api/id-geospatial-frameworks
"""
...
router = APIRouter(prefix="/api/id-geospatial-frameworks", tags=["w6-id"])
_engine = IdGeospatialFrameworkEngine()
