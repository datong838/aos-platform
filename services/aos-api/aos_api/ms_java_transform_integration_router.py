...
Router: /api/java-transform-integrations
"""
...
router = APIRouter(prefix="/api/java-transform-integrations", tags=["w6-ms"])
_engine = JavaTransformIntegrationEngine()
