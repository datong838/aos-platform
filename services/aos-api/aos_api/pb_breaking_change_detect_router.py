"""
W5 — 重大更改检测
Router: /api/breaking-change-detects
"""
...
router = APIRouter(prefix="/api/breaking-change-detects", tags=["w5-pb"])
_engine = BreakingChangeDetectEngine()
