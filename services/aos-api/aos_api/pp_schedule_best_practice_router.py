"""
W5 — 调度最佳实践
Router: /api/schedule-best-practices
"""
...
router = APIRouter(prefix="/api/schedule-best-practices", tags=["w5-pp"])
_engine = ScheduleBestPracticeEngine()
