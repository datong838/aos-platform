"""
W5 — 调度故障排查
Router: /api/schedule-troubleshoots
"""
...
router = APIRouter(prefix="/api/schedule-troubleshoots", tags=["w5-pp"])
_engine = ScheduleTroubleshootEngine()
