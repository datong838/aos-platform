"""
W5 — 变换管道规则
Router: /api/transform-pipeline-rules
"""
...
router = APIRouter(prefix="/api/transform-pipeline-rules", tags=["w5-rl"])
_engine = TransformPipelineRuleEngine()
