"""
W6 — 多源异构三种解法
Router: /api/multi-source-heterogeneous
"""
...
router = APIRouter(prefix="/api/multi-source-heterogeneous", tags=["w6-zz"])
_engine = MultiSourceHeterogeneousEngine()
