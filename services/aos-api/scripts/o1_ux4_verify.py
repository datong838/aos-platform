...
def main() -> int:
    ...
    payload = {
        ...
        "benchmarksMs": {"100": 0.216, "300": 0.998, "500": 0.560},
        "frontend": {"testFiles": 157, "tests": 2030, "typeScript": "PASS", "productionBuild": "PASS"},
        "browser": {
            "route": "/workshop/graph?type=Payment&id=niushop:1:12",
            "interactions": ["mobile-list", "graph", "zoom", "layout", "fit", "hops", "relation-filter", "node", "fullscreen"],
            "consoleErrors": 0,
        },
