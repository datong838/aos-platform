...
SCRIPT = (
    ...
    / "scripts"
    / "aip"
    / "bootstrap_r08_shopping_advisor_binding_authority.py"
)
SPEC = importlib.util.spec_from_file_location(
    "bootstrap_r08_shopping_advisor_binding_authority", SCRIPT
)
...
def test_plan_is_tenant_exact_and_has_no_runtime_side_effects() -> None:
    ...
    assert plan["instanceId"] == "ecommerce.shopping_advisor.default"
