...
SCRIPT = (
    ...
    / "scripts/aip/refresh_r08_shopping_advisor_runtime_tail.py"
)
SPEC = importlib.util.spec_from_file_location(
    "refresh_r08_shopping_advisor_runtime_tail", SCRIPT
)
...
def test_plan_is_exact_and_has_no_provider_or_agent_side_effect() -> None:
    ...
    assert "ecommerce.shopping_advisor.skill.G04.r2" in plan["skillBindings"]
