...
def test_openapi_freezes_workshop_reads_and_governed_internal_commands() -> None:
    ...
    assert operations == {
        ...
        "ecommerceWorkshopAipFeatureRevoke": (
            "/v1/ecommerce-workshop/aip-features/{feature_id}/revoke",
            "post",
        ),
        ...
        "ecommerceWorkshopMediaStudioFullProductionScenarioGet": (
            "/v1/ecommerce-workshop/views/media-studio/full-production-scenario",
            "get",
        ),
        ...
        "ecommerceWorkshopAnalystLearningScenarioGet": (
            "/v1/ecommerce-workshop/views/analyst/learning-scenario",
            "get",
        ),
        ...
        "ecommerceWorkshopTaskCockpitBatchScenarioGet": (
            "/v1/ecommerce-workshop/views/task-cockpit/batch-scenario",
            "get",
        ),
